...
public class GenericTypeAwarePropertyDescriptorUtils extends PropertyDescriptor {
    ...
    public GenericTypeAwarePropertyDescriptorUtils(Class<?> beanClass, String propertyName,
    ...
    public Method getWriteMethodForActualAccess() {
        ...
        if (ambiguousCandidates != null) {
            ...
            LogFactory.getLog(GenericTypeAwarePropertyDescriptorUtils.class).warn("Invalid JavaBean property '" +
    ...
    public boolean equals(Object other) {
        ...
        if (!(other instanceof GenericTypeAwarePropertyDescriptorUtils)) {
            return false;
        }
        GenericTypeAwarePropertyDescriptorUtils otherPd = (GenericTypeAwarePropertyDescriptorUtils) other;
